 ...
 */
package com.alfath.musicall.app.yt.innertube

import android.util.Log
import com.alfath.musicall.app.data.model.NanzMusifyTrack
import com.alfath.musicall.app.data.settings.AudioQuality
import com.alfath.musicall.app.yt.NanzMusifyHttp
import com.alfath.musicall.app.yt.ResolvedAudio
import com.alfath.musicall.app.yt.innertube.InnertubeRequest.Client
...
class InnertubeFallback {
    ...
    suspend fun search(query: String, filter: com.alfath.musicall.app.data.model.SearchFilter, limit: Int = 30): List<NanzMusifyTrack> =
        withContext(Dispatchers.IO) {
            ensureReady()
            runCatching {
     ...
     */
    private fun searchParams(filter: com.alfath.musicall.app.data.model.SearchFilter): String? = when (filter) {
        com.alfath.musicall.app.data.model.SearchFilter.SONGS -> "EgWKAQIIAWoKEAkQBRAKEAMQBA%3D%3D"
        com.alfath.musicall.app.data.model.SearchFilter.VIDEOS -> "EgWKAQIQAWoKEAkQChAFEAMQBA%3D%3D"
        com.alfath.musicall.app.data.model.SearchFilter.ALBUMS -> "EgWKAQIYAWoKEAkQChAFEAMQBA%3D%3D"
        com.alfath.musicall.app.data.model.SearchFilter.ARTISTS -> "EgWKAQIgAWoKEAkQChAFEAMQBA%3D%3D"
        com.alfath.musicall.app.data.model.SearchFilter.PLAYLISTS -> "EgeKAQQoAEABagoQAxAEEAoQCRAF"
        com.alfath.musicall.app.data.model.SearchFilter.PODCASTS -> "EgWKAQJQAWoKEAkQChAFEAMQBA%3D%3D"
        com.alfath.musicall.app.data.model.SearchFilter.ALL -> null
    }
