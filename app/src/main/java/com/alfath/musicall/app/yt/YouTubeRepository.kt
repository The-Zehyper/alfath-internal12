 ...
 */
package com.alfath.musicall.app.yt
        ...
        OkHttpClient.Builder()
            ...
            .addInterceptor { chain ->
                ...
                if (url.host.endsWith("googlevideo.com")) {
                    ...
                    val specUa = com.alfath.musicall.app.yt.innertube.PlayerClientLadder
...
data class ResolvedAudio(
     ...
     * di URL). Dipakai [com.alfath.musicall.app.yt.innertube.StreamUrlValidator] untuk
...
class YouTubeRepository {
    ...
    suspend fun bundle(videoId: String): YtTrackBundle {
        ...
        val seedHashtags = com.alfath.musicall.app.data.taste.MusicTextAnalyzer
    ...
    fun resolveAudioBlocking(
        ...
        if (!com.alfath.musicall.app.yt.innertube.PlayerClientLadder.extractorBypassed()) {
            val info = try {
                StreamInfo.getInfo(ServiceList.YouTube, "https://www.youtube.com/watch?v=$videoId")
            } catch (e: Exception) {
            ...
            com.alfath.musicall.app.yt.innertube.PlayerClientLadder.noteExtractorSuccess()
            ...
            val mime = if (manifest) {
                com.alfath.musicall.app.yt.innertube.InnertubeFallback.HLS_MIME
            } else {
            ...
            if (!manifest) {
                val probe = com.alfath.musicall.app.yt.innertube.StreamUrlValidator.validate(
                    url = url,
    ...
    private val fallback: com.alfath.musicall.app.yt.innertube.InnertubeFallback by lazy {
        com.alfath.musicall.app.yt.innertube.InnertubeFallback()
    }
    ...
    private fun noteExtractorFailure(videoId: String, e: Exception) {
        ...
        if (message.contains("SABR", ignoreCase = true)) {
            com.alfath.musicall.app.yt.innertube.PlayerClientLadder.noteExtractorSabr(
    ...
    private fun fallbackResolve(
        ...
        } catch (e: com.alfath.musicall.app.yt.innertube.StreamUnavailableException) {
    ...
    data class StreamProbe(
        ...
        val ladder: com.alfath.musicall.app.yt.innertube.LadderProbe,
    ...
    suspend fun probeStream(videoId: String): StreamProbe = withContext(Dispatchers.IO) {
        ...
        val ladderProbe = runCatching { fallback.probeBlocking(id, defaultQuality) }.getOrElse { e ->
            com.alfath.musicall.app.yt.innertube.LadderProbe(
                videoId = id,
                usableClient = null,
                audioUrlFound = false,
                manifestClient = null,
                ...
                totalMs = 0L,
                attempts = listOf(
                    com.alfath.musicall.app.yt.innertube.ProbeAttempt(
                        client = "-",
        ...
        StreamProbe(
            ...
            ladder = ladderProbe,
            diagnostics = com.alfath.musicall.app.yt.innertube.PlayerClientLadder.report(),
        )
    }
