...
import com.alfath.musicall.app.MainActivity
import com.alfath.musicall.app.player.audio.LoudnessStore
import com.alfath.musicall.app.player.audio.SilenceDetectorAudioProcessor
...
class PlaybackService : MediaSessionService() {
    ...
    private fun observeAudioSettings(locator: com.alfath.musicall.app.core.ServiceLocator, player: ExoPlayer) {
        serviceScope.launch {
     ...
     */
    private fun observeNormalization(locator: com.alfath.musicall.app.core.ServiceLocator, player: ExoPlayer) {
